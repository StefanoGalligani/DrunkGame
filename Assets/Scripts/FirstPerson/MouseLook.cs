...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class MouseLook
    {
        ...
        public void Init(Transform character, Transform head)
        {
            m_CharacterTargetRot = character.localRotation;
            m_HeadTargetRot = head.localRotation;
        }
        ...
        public void LookRotation(Transform character, Transform head)
        {
            ...
            if(smooth)
            {
                ...
                head.localRotation = Quaternion.Slerp (head.localRotation, m_HeadTargetRot,
                    smoothTime * Time.deltaTime);
            }
            else
            {
                character.localRotation = m_CharacterTargetRot;
                head.localRotation = m_HeadTargetRot;
            }
