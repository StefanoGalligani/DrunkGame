...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void UpdateCameraPosition(float speed)
        {
            ...
            {
                head.transform.localPosition = m_HeadBob.DoHeadBob(m_CharacterController.velocity.magnitude +
                                      (speed*(m_IsWalking ? 1f : m_RunstepLenghten)));

                newHeadPosition = head.transform.localPosition;
            }
            else
            {
                newHeadPosition = head.transform.localPosition;
            }
            head.transform.localPosition = newHeadPosition;
        }
        ...
        {
            m_MouseLook.LookRotation (transform, head.transform );
        }
